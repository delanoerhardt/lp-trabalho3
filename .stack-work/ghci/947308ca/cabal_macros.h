...
/* package trab3-0.0.0 */
#ifndef VERSION_trab3
#define VERSION_trab3 "0.0.0"
#endif /* VERSION_trab3 */
#ifndef MIN_VERSION_trab3
#define MIN_VERSION_trab3(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_trab3 */
...
#define CURRENT_COMPONENT_ID "trab3-0.0.0-GeIktXr9sk8GeyXLWe2zj9-stack-test"
